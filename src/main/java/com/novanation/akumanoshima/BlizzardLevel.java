...
public class BlizzardLevel implements Level {
    ...
    private static final int SECONDARY_TILE_PERCENT = 75;       // Represents dirt, stone, snow pile
    ...
    public BlizzardLevel(GamePanel panel) { this.panel = panel; }
    ...
    {
        Chunk newChunk = new Chunk((currentTile * TILE_LENGTH), yPos, CHUNK_WIDTH, (elevation / TILE_LENGTH), TILE_LENGTH, previousTile, WorldType.BLIZZARD);
    ...
    {
        Tile newTile = new Tile(panel, (tileOffset * TILE_LENGTH), yPos + (i * TILE_LENGTH), TILE_LENGTH, tileType, WorldType.BLIZZARD);
    ...
    public void createLevel()
    {
        ...
        while (currentTile < (WORLD_LENGTH * 2))
        {
            ...
            {
                Tile newTile = new Tile(panel, (currentTile * TILE_LENGTH), panelHeight, TILE_LENGTH, TileType.PRIMARY, WorldType.BLIZZARD);
    ...
    public void setMainTile()
    {
        ...
        {
            Tile newTile = new Tile(panel, (currentTile * 64), yPos, TILE_LENGTH, TileType.PRIMARY, WorldType.BLIZZARD);
            tileMap.put(newTile.getX(), newTile);
    ...
    public void setSecondaryTile()
    {
        ...
        {
            Tile newTile = new Tile(panel, (currentTile * 64), yPos, TILE_LENGTH, TileType.SECONDARY, WorldType.BLIZZARD);
            tileMap.put(newTile.getX(), newTile);
    ...
    public void setTertiaryTile()
    {
        ...
        {
            Tile newTile = new Tile(panel, (currentTile * 64), yPos, TILE_LENGTH, TileType.TERTIARY, WorldType.BLIZZARD);
            tileMap.put(newTile.getX(), newTile);
